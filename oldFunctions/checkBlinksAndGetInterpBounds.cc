...
{
	// add _noBlinks to the new file name
...
// 							cout << ' ' << trialSet.g_currentTr(); //<< ' ' << blinkDuration ;
							...
							{
								includeTrial = true;
								// do nothing for blinks smaller than 20 ms! // this might make a problem if the duration is shorter given the onset of the target!!
								// it might be better to interpolate everything!
